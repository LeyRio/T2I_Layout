...
dicts = {
  'A red colored car':{'Red Car': [[0.15, 0.25, 0.85, 0.75]]},
  'A black colored car':{'Black Car': [[0.15, 0.25, 0.85, 0.75]]},
  'A pink colored car':{'Pink Car': [[0.15, 0.25, 0.85, 0.75]]},
  'A black colored dog':{'Black Dog':[[0.2,0.3,0.8,0.8]]},
  'A red colored dog':{'Red Dog':[[0.2,0.3,0.8,0.8]]},
  'A blue colored dog':{'Blue Dog':[[0.2,0.3,0.8,0.8]]},
  'A green colored banana':{'Green Banana':[[0.35,0.3,0.75,0.8]]},
  'A red colored banana':{'Red banana':[[0.35,0.3,0.75,0.8]]},
  'A black colored banana':{'Black Banana':[[0.35,0.3,0.75,0.8]]},
  'A white colored sandwich':{'White colored sandwich':[[0.2,0.2,0.8,0.8]]},
  'A black colored sandwich':{'black colored sandwich':[[0.2,0.2,0.8,0.8]]},
  'An orange colored sandwich':{'orange colored sandwich':[[0.2,0.2,0.8,0.8]]},
  'A pink colored giraffe':{'pink colored giraffe':[[0.25,0.1,0.75,0.9]]},
  'A yellow colored giraffe':{'yellow colored giraffe':[[0.25,0.1,0.75,0.9]]},
  'A brown colored giraffe':{'brown colored giraffe':[[0.25,0.1,0.75,0.9]]},
  'A red car and a white sheep':{'red car':[[0.025,0.3,0.5,0.75]],'white sheep':[[0.615,0.2,0.975,0.8]]},
  'A blue bird and a brown bear':{'blue bird':[[0.1,0.4,0.4,0.6]],'brown bear':[[0.5,0.2,0.975,0.8]]},
  'A green apple and a black backpack':{'green apple':[[0.1,0.4,0.4,0.6]],'black backpack':[[0.5,0.2,0.975,0.8]]},
  'A green cup and a blue cell phone':{'green cup':[[0.025,0.3,0.415,0.7]],'blue cell phone':[[0.6,0.2,0.925,0.8]]},
  'A yellow book and a red vase':{'yellow book':[[0.025,0.3,0.415,0.7]],'red vase':[[0.55,0.2,0.95,0.8]]},
  'A white car and a red sheep':{'white car':[[0.025,0.3,0.5,0.75]],'red sheep':[[0.615,0.2,0.975,0.8]]},
  'A brown bird and a blue bear':{'brown bird':[[0.1,0.4,0.4,0.6]],'blue bear':[[0.5,0.2,0.975,0.8]]},
  'A black apple and a green backpack':{'black apple':[[0.1,0.4,0.4,0.6]],'green backpack':[[0.5,0.2,0.975,0.8]]},
  'A blue cup and a green cell phone':{'blue cup':[[0.025,0.3,0.415,0.7]],'green cell phone':[[0.6,0.2,0.925,0.8]]},
  'A red book and a yellow vase':{'red book':[[0.025,0.3,0.415,0.7]],'yellow vase':[[0.55,0.2,0.95,0.8]]},
  'One car on the street':{'a car':[[0.2,0.2,0.8,0.8]]},
  'Two cars on the street':{'a car':[[0.025,0.3,0.415,0.7],[0.55,0.3,0.95,0.7]]},
  'Three cars on the street':{'a car':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95],[0.55,0.3,0.95,0.7]]},
  'Four cars on the street':{'a car':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95],[0.55,0.15,0.95,0.55],[0.55,0.5,0.95,0.9]]},
  'Five cars on the street':{'a car':[[0.025,0.025,0.35,0.35],[0.25,0.2,0.475,0.475],[0.025,0.55,0.415,0.95],[0.55,0.15,0.95,0.55],[0.55,0.5,0.95,0.9]]},
  'One dog on the street':{'a dog':[[0.2,0.2,0.8,0.8]]},
  'Two dogs on the street':{'a dog':[[0.025,0.3,0.415,0.7],[0.55,0.3,0.95,0.7]]},
  'Three dogs on the street':{'a dog':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95],[0.55,0.3,0.95,0.7]]},
  'Four dogs on the street':{'a dog':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95],[0.55,0.15,0.95,0.55],[0.55,0.5,0.95,0.9]]},
  'Five dogs on the street':{'a dog':[[0.025,0.025,0.35,0.35],[0.25,0.2,0.475,0.475],[0.025,0.55,0.415,0.95],[0.55,0.1,0.95,0.5],[0.55,0.6,0.95,0.9]]},
  'One cat and one dog sitting on the grass':{'a cat':[[0.025,0.3,0.415,0.7]],'a dog':[[0.55,0.3,0.95,0.7]]},
  'One cat and two dogs sitting on the grass':{'a cat':[[0.025,0.025,0.415,0.425]],'a dog':[[0.025,0.55,0.415,0.95],[0.55,0.3,0.95,0.7]]},
  'One cat and three dogs sitting on the grass':{'a cat':[[0.025,0.025,0.415,0.425]],'a dog':[[0.025,0.55,0.415,0.95],[0.55,0.15,0.95,0.55],[0.55,0.5,0.95,0.9]]},
  'Two cats and one dog sitting on the grass':{'a cat':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95]],'a dog':[[0.55,0.3,0.95,0.7]]},
  'Two cats and two dogs sitting on the grass':{'a cat':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95]],'a dog':[[0.55,0.15,0.95,0.55],[0.55,0.5,0.95,0.9]]},
  'Two cats and three dogs sitting on the grass':{'a cat':[[0.025,0.025,0.35,0.35],[0.25,0.2,0.475,0.475]],'a dog':[[0.025,0.55,0.415,0.95],[0.55,0.1,0.95,0.5],[0.55,0.6,0.95,0.9]]},
  'Three cats and one dog sitting on the grass':{'a cat':[[0.025,0.025,0.415,0.425],[0.025,0.55,0.415,0.95],[0.55,0.15,0.95,0.55]],'a dog':[[0.55,0.5,0.95,0.9]]},
  'Three cats and two dogs sitting on the grass':{'a cat':[[0.025,0.025,0.35,0.35],[0.25,0.2,0.475,0.475],[0.025,0.55,0.415,0.95]],'a dog':[[0.55,0.1,0.95,0.5],[0.55,0.6,0.95,0.9]]},
  'Three cats and three dogs sitting on the grass':{'a cat':[[0.025,0.025,0.35,0.35],[0.25,0.2,0.475,0.475],[0.025,0.55,0.415,0.95]],'a dog':[[0.55,0.1,0.95,0.5],[0.55,0.6,0.75,0.9],[0.765,0.6,1.0,1.0]]},
  'A train on top of a surfboard':{'a train':[[0.1,0.25,0.85,0.65]],'a surfboard':[[0.3,0.7,0.8,0.95]]},
  'A wine glass on top of a dog':{'a wine glass':[[0.2,0.25,0.4,0.55]],'a dog':[[0.15,0.45,0.75,0.9]]},
  'A bicycle on top of a boat':{'a bicycle':[[0.2,0.25,0.75,0.55]],'a boat':[[0.15,0.45,0.85,0.9]]},
  'An umbrella on top of a spoon':{'an umbrella':[[0.2,0.15,0.75,0.6]],'a spoon':[[0.4,0.75,0.75,0.9]]},
  'A laptop on top of a teddy bear':{'a laptop':[[0.2,0.15,0.75,0.6]],'a teddy bear':[[0.4,0.65,0.9,0.975]]},
  'A giraffe underneath a microwave':{'a giraffe':[[0.2,0.4,0.75,0.9]],'microwave':[[0.4,0.05,0.7,0.3]]},
  'A donut underneath a toilet':{'a donut':[[0.45,0.65,0.75,0.9]],'a toliet':[[0.3,0.05,0.8,0.55]]},
  'A hair drier underneath a sheep':{'a hair drier':[[0.35,0.75,0.75,0.975]],'a sheep':[[0.2,0.05,0.8,0.65]]},
  'A tennis racket underneath a traffic light':{'a tennis racket':[[0.35,0.65,0.75,0.975]],'a traffic light':[[0.35,0.05,0.8,0.6]]},
  'A zebra underneath a broccoli':{'a zebra':[[0.25,0.4,0.9,0.975]],'a broccoli':[[0.35,0.05,0.65,0.3]]},
  'A banana on the left of an apple':{'a banana':[[0.1,0.2,0.4,0.8]],'an apple':[[0.6,0.2,1.0,0.8]]},
  'A couch on the left of a chair':{'a couch':[[0.05,0.35,0.6,0.7]],'a chair':[[0.7,0.2,0.975,0.7]]},
  'A car on the left of a bus':{'a car':[[0.05,0.35,0.4,0.7]],'a bus':[[0.5,0.2,0.975,0.7]]},
  'A cat on the left of a dog':{'a car':[[0.1,0.2,0.4,0.8]],'a dog':[[0.6,0.2,1.0,0.8]]},
  'A carrot on the left of a broccoli':{'a carrot':[[0.1,0.2,0.4,0.8]],'a broccoli':[[0.6,0.2,1.0,0.8]]},
  'A pizza on the right of a suitcase':{'a pizza':[[0.7,0.4,1.0,0.7]],'a suitcase':[[0.1,0.2,0.6,0.8]]},
  'A cat on the right of a tennis racket':{'a cat':[[0.6,0.2,1.0,0.8]],'a tennis racket':[[0.1,0.3,0.4,0.7]]},
  'A stop sign on the right of a refrigerator':{'a stop sign':[[0.55,0.2,0.976,0.8]],'a refrigerator':[[0.1,0.2,0.4,0.8]]},
  'A sheep to the right of a wine glass':{'a sheep':[[0.5,0.2,0.975,0.8]],'a wine glass':[[0.1,0.3,0.4,0.7]]},
  'A zebra to the right of a fire hydrant':{'a zebra':[[0.5,0.2,0.975,0.8]],'a fire hydrant':[[0.1,0.3,0.4,0.7]]},
  ####### 接下来是 不太重要的一些文本
  # 反事实
  'A horse riding an astronaut.':{'a horse':[[0.2,0.2,0.8,0.55]],'an astronaut.':[[0.35,0.5,0.75,0.8]]},
  'A pizza cooking an oven.':{'a pizza':[[0.2,0.2,0.6,0.6]],'an oven':[[0.65,0.4,0.9,0.8]]},
  'A bird scaring a scarecrow.':{'a bird':[[0.2,0.4,0.5,0.7]],'a scarecrow':[[0.6,0.2,0.9,0.8]]},
  'A blue coloured pizza.':{'a blue coloured pizza':[[0.2,0.2,0.8,0.8]]},
  'Hovering cow abducting aliens.':{'a cow':[[0.2,0.05,0.8,0.5]],'aliens':[[0.2,0.6,0.6,0.975]]},
  'A panda making latte art.':{'a panda':[[0.1,0.2,0.6,0.8]],'latte art':[[0.55,0.4,0.8,0.8]]},
  'A shark in the desert.':{'a shark':[[0.2,0.3,0.8,0.7]],'desert':[[0.0,0.2,1.0,1.0]]},
  'An elephant under the sea.':{'an elephant':[[0.2,0.3,0.8,0.7]],'sea':[[0.0,0.0,1.0,0.8]]},
  'Rainbow coloured penguin.':{'Rainbow coloured penguin':[[0.2,0.2,0.8,0.8]]},
  'A fish eating a pelican.':{'a fish':[[0.2,0.2,0.6,0.5]],'a pelican':[[0.67,0.2,1.0,0.8]]},
  # DALLE
  'A triangular purple flower pot. A purple flower pot in the shape of a triangle.':{'triangular purple flower pot':[[0.2,0.2,0.8,0.8]]},
  'A triangular orange picture frame. An orange picture frame in the shape of a triangle.':{' triangular orange picture frame':[[0.2,0.2,0.8,0.8]]},
  'A triangular pink stop sign. A pink stop sign in the shape of a triangle.':{'triangular pink stop sign':[[0.2,0.2,0.8,0.8]]},
  'A cube made of denim. A cube with the texture of denim.':{'A cube made of denim.':[[0.2,0.2,0.8,0.8]]},
  ...
  'A collection of nail is sitting on a table.':{'A collection of nail':[[0.4,0.4,0.7,0.6]],'a table':[[0.2,0.6,0.8,0.975]]},
  'A single clock is sitting on a table.':{'a clock':[[0.4,0.2,0.7,0.6]],'a table':[[0.2,0.6,0.8,0.975]]},
  'A couple of glasses are sitting on a table.':{'a glass':[[0.2,0.4,0.5,0.6],[0.6,0.4,0.9,0.6]],'a table':[[0.1,0.6,0.9,0.975]]},
  'An illustration of a large red elephant sitting on a small blue mouse.':{'a large red elephant':[[0.2,0.2,0.8,0.6]],'a small blue mouse':[[0.4,0.6,0.6,0.8]]},
  'An illustration of a small green elephant standing behind a large red mouse.':{'a small green elephant':[[0.3,0.3,0.6,0.6]],'a large red mouse':[[0.45,0.2,0.9,0.8]]},
  'A small blue book sitting on a large red book.':{'a small blue book':[[0.2,0.3,0.7,0.55]],'a large red book':[[0.2,0.5,0.8,0.975]]},
  'A stack of 3 plates. A blue plate is on the top, sitting on a blue plate. The blue plate is in the middle, sitting on a green plate. The green plate is on the bottom.':{'a blue plate':[[0.2,0.05,0.7,0.35],[0.2,0.35,0.7,0.6]],'a green plate':[[0.2,0.65,0.7,0.975]]},
  'A stack of 3 cubes. A red cube is on the top, sitting on a red cube. The red cube is in the middle, sitting on a green cube. The green cube is on the bottom.':{'a red cube':[[0.3,0.05,0.6,0.35],[0.3,0.35,0.6,0.6]],'a green cube':[[0.3,0.65,0.6,0.975]]},
  'A stack of 3 books. A green book is on the top, sitting on a red book. The red book is in the middle, sitting on a blue book. The blue book is on the bottom.':{'a green book':[[0.3,0.05,0.6,0.35]],'a red book':[[0.3,0.35,0.6,0.6]],'a blue book':[[0.3,0.65,0.6,0.975]]},
...
yaml_dir = 'annotation_human.yaml'
